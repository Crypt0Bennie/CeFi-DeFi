...
function AddLiquidity() external payable {
    ...
    distributionY[0] = 333333333333333333;
    distributionY[1] = 333333333333333334;
    distributionY[2] = 333333333333333333;
...
// To figure out amountXMin and amountYMin, we calculate how much X and Y underlying we have as liquidity
    ...
    uint256 LBTokenAmount1 = ILBTokenNFT(LBPool).balanceOf(address(this), (CurrentDepositID - 1));
    uint256 LBTokenAmount2 = ILBTokenNFT(LBPool).balanceOf(address(this), (CurrentDepositID - 2));
    amounts[0] = LBTokenAmount;
    amounts[1] = LBTokenAmount1;
    amounts[2] = LBTokenAmount2;
